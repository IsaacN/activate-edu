		...
		<section class="team-1">
				<div class="container">
					...
					<div class="row space-bottom-large">
						...
						<div class="col-sm-6">
							<div class="team-1-member">
								...
								<h5>Tutor, Co-Founder and Operations Manager</h5>
								<p class="space-top-small">
									Nathan is a 20-year-old studying Business (Economics) and Mathematics (Decision Science) at the Queensland University of Technology. He is talented in tailoring learning to individual students and bringing out the best in everyone he comes into contact with. He is an avid sports-lover despite his lacklustre frame. Nathan graduated from Sheldon College, where he was school captain, in 2014 with an OP 1.<br><br>Nathan specialises in tutoring Maths A, B &amp; C, Chemistry and Business.
								</p>
							</div>
						</div>
					...
					<div class="row space-bottom-large">
						...
						<div class="col-sm-4">
							<div class="team-1-member">
								<div id='ben' class='profile-photo'> </div>
								<h2>Ben Eliasaf</h2>
								<h5>Tutor</h5>
								<p class="space-top-small">
							...
							<div class="team-1-member">
								<div id='georgia' class='profile-photo'> </div>
								<h2>Georgia Light</h2>
								<h5>Tutor</h5>
								<p class="space-top-small">
					...
					<div class="row space-bottom-large">
						<div class="col-sm-4 col-sm-offset-2">
							<div class="team-1-member">
								<div id='panashe' class='profile-photo'> </div>
							...
							<div class="team-1-member">
								<div id='qv' class='profile-photo'> </div>
								<h2>Qv Ho</h2>
								<h5>Tutor</h5>
								<p class="space-top-small">
